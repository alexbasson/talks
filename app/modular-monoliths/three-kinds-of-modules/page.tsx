    ...
    <div style={{display: 'grid', gridTemplateColumns: `${leftColumnWidth}px 1fr`}}>
      <div>
        ...
        <ul className={"mt-96 pl-16 list-disc"}>
          <li><span className={domainBlue.className}>policy modules</span></li>
      ...
      <div>
        <svg viewBox={`0 0 ${width} ${height}`} width={width} height={height}>
          <DomainModule geometry={geometry} fill={domainBlue.hexValue} text="policy"/>
          ...
          <DeployableModule geometry={geometry} stroke={deployableGreen.hexValue} width={2 * scale}
                            height={1.5 * scale}/>
          <text className={"text-base"} x={100} y={200} stroke={deployableGreen.hexValue}
