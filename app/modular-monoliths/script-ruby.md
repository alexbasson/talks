...
Hi everyone, thanks for coming. My name is Alex Basson, I'm a Delivery Lead here at Stride.
...
To get a little bit concrete, looking at our online chess example, this is a cross-context adapter that could bridge the gap between the `GameInitializer` port and the `SetupBoard` port. So what this looks like,
